...
class HistoryUpdateRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["RequestHeader", "HistoryUpdateDetails"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.history_update_details:
            for _item_history_update_details in self.history_update_details:
                if _item_history_update_details:
                    _items.append(_item_history_update_details.to_dict())
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "HistoryUpdateDetails": [ExtensionObject.from_dict(_item) for _item in obj["HistoryUpdateDetails"]] if obj.get("HistoryUpdateDetails") is not None else None
        })
        return _obj
