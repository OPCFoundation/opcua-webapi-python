    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.input_argument_diagnostic_infos:
            for _item_input_argument_diagnostic_infos in self.input_argument_diagnostic_infos:
                if _item_input_argument_diagnostic_infos:
                    _items.append(_item_input_argument_diagnostic_infos.to_dict())
