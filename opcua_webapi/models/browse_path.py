...
class BrowsePath(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["StartingNode", "RelativePath"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "StartingNode": obj.get("StartingNode"),
            "RelativePath": RelativePath.from_dict(obj["RelativePath"]) if obj.get("RelativePath") is not None else None
        })
        return _obj
