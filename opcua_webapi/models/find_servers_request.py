...
class FindServersRequest(BaseModel):
    ...
    server_uris: Optional[List[StrictStr]] = Field(default=None, alias="ServerUris")
    __properties: ClassVar[List[str]] = ["RequestHeader", "EndpointUrl", "LocaleIds", "ServerUris"]
