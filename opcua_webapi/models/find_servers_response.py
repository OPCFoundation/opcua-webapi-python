...
class FindServersResponse(BaseModel):
    ...
    servers: Optional[List[ApplicationDescription]] = Field(default=None, alias="Servers")
    __properties: ClassVar[List[str]] = ["ResponseHeader", "Servers"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "Servers": [ApplicationDescription.from_dict(_item) for _item in obj["Servers"]] if obj.get("Servers") is not None else None
        })
        return _obj
