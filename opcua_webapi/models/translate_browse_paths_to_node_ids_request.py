...
class TranslateBrowsePathsToNodeIdsRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["RequestHeader", "BrowsePaths"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.browse_paths:
            for _item_browse_paths in self.browse_paths:
                if _item_browse_paths:
                    _items.append(_item_browse_paths.to_dict())
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "BrowsePaths": [BrowsePath.from_dict(_item) for _item in obj["BrowsePaths"]] if obj.get("BrowsePaths") is not None else None
        })
        return _obj
