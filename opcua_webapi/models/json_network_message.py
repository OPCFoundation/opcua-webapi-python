...
class JsonNetworkMessage(BaseModel):
    """
    ...
    messages: Optional[Any] = Field(default=None, alias="Messages")
    __properties: ClassVar[List[str]] = ["MessageId", "MessageType", "PublisherId", "WriterGroupName", "DataSetClassId", "Messages"]
