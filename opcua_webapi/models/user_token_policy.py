...
class UserTokenPolicy(BaseModel):
    ...
    token_type: Optional[StrictInt] = Field(default=None, description="[Link to specification](https://reference.opcfoundation.org/v105/Core/docs/Part4/7.42).", alias="TokenType")
    ...
    __properties: ClassVar[List[str]] = ["PolicyId", "TokenType", "IssuedTokenType", "IssuerEndpointUrl", "SecurityPolicyUri"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "IssuedTokenType": obj.get("IssuedTokenType"),
            "IssuerEndpointUrl": obj.get("IssuerEndpointUrl"),
