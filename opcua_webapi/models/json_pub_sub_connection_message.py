...
class JsonPubSubConnectionMessage(BaseModel):
    """
    ...
    connection: Optional[PubSubConnectionDataType] = Field(default=None, alias="Connection")
    __properties: ClassVar[List[str]] = ["MessageId", "MessageType", "PublisherId", "Timestamp", "Connection"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "Connection": PubSubConnectionDataType.from_dict(obj["Connection"]) if obj.get("Connection") is not None else None
        })
        return _obj
