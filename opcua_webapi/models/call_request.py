...
class CallRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["RequestHeader", "MethodsToCall"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.methods_to_call:
            for _item_methods_to_call in self.methods_to_call:
                if _item_methods_to_call:
                    _items.append(_item_methods_to_call.to_dict())
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "MethodsToCall": [CallMethodRequest.from_dict(_item) for _item in obj["MethodsToCall"]] if obj.get("MethodsToCall") is not None else None
        })
        return _obj
