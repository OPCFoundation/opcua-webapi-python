...
class GetEndpointsRequest(BaseModel):
    ...
    profile_uris: Optional[List[StrictStr]] = Field(default=None, alias="ProfileUris")
    __properties: ClassVar[List[str]] = ["RequestHeader", "EndpointUrl", "LocaleIds", "ProfileUris"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "ProfileUris": obj.get("ProfileUris")
        })
        return _obj
