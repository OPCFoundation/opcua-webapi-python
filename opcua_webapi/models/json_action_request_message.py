...
class JsonActionRequestMessage(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["DataSetWriterId", "ActionTargetId", "DataSetWriterName", "WriterGroupName", "MetaDataVersion", "MinorVersion", "Timestamp", "MessageType", "RequestId", "ActionState", "Payload"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "ActionTargetId": obj.get("ActionTargetId") if obj.get("ActionTargetId") is not None else 0,
            ...
            "RequestId": obj.get("RequestId") if obj.get("RequestId") is not None else 0,
            "ActionState": obj.get("ActionState"),
