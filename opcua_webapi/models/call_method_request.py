...
class CallMethodRequest(BaseModel):
    ...
    input_arguments: Optional[List[Variant]] = Field(default=None, alias="InputArguments")
    __properties: ClassVar[List[str]] = ["ObjectId", "MethodId", "InputArguments"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "InputArguments": [Variant.from_dict(_item) for _item in obj["InputArguments"]] if obj.get("InputArguments") is not None else None
        })
        return _obj
