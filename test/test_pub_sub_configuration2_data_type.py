        ...
        if include_optional:
            return PubSubConfiguration2DataType(
                subscribed_data_sets = [
                    opcua_webapi.models.standalone_subscribed_data_set_data_type.StandaloneSubscribedDataSetDataType(
                        name = '', 
                        data_set_folder = [
                            ''
                            ], 
                ...
                security_groups = [
                    opcua_webapi.models.security_group_data_type.SecurityGroupDataType(
                        name = '', 
                ...
                pub_sub_key_push_targets = [
                    opcua_webapi.models.pub_sub_key_push_target_data_type.PubSubKeyPushTargetDataType(
                        application_uri = '', 
                        push_target_folder = [
                            ''
                            ], 
