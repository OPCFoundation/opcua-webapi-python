...
class TestJsonPubSubConnectionMessage(unittest.TestCase):
    """JsonPubSubConnectionMessage unit test stubs"""
    ...
    def make_instance(self, include_optional) -> JsonPubSubConnectionMessage:
        """Test JsonPubSubConnectionMessage
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `JsonPubSubConnectionMessage`
        """
        model = JsonPubSubConnectionMessage()
        if include_optional:
            return JsonPubSubConnectionMessage(
                ...
                connection = opcua_webapi.models.pub_sub_connection_data_type.PubSubConnectionDataType(
                    name = '', 
                    enabled = True, 
    ...
    def testJsonPubSubConnectionMessage(self):
        """Test JsonPubSubConnectionMessage"""
