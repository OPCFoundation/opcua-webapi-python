...
class TestJsonActionResponderMessage(unittest.TestCase):
    """JsonActionResponderMessage unit test stubs"""
    ...
    def make_instance(self, include_optional) -> JsonActionResponderMessage:
        """Test JsonActionResponderMessage
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `JsonActionResponderMessage`
        """
        model = JsonActionResponderMessage()
        if include_optional:
    ...
    def testJsonActionResponderMessage(self):
        """Test JsonActionResponderMessage"""
